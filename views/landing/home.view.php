        ...
        <div class="row justify-content-center">
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-4">
                            <div class="single-reason">
                                <div class="icon-box">
                                    <div class="part-icon">
                                        <img src="<?=STATIC_ROOT; ?>/landing/img/svg/withdraw.svg" alt="">
                                    </div>
                                </div>
                                <div class="part-text">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-4">
                            <div class="single-reason">
                                <div class="icon-box">
                                    <div class="part-icon">
                                        <img src="<?=STATIC_ROOT; ?>/landing/img/svg/referral.svg" alt="">
                                    </div>
                                </div>
                                <div class="part-text">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-4">
                            <div class="single-reason">
                                <div class="icon-box">
                                    <div class="part-icon">
                                        <img src="<?=STATIC_ROOT; ?>/landing/img/svg/affiliate-marketing.svg" alt="">
                                    </div>
                                </div>
                                <div class="part-text">
            ...
            <div class="col-xl-4 col-lg-2 d-xl-flex d-lg-none d-block align-items-end">
                <div class="part-img">
                    ...
                    <img src="<?=STATIC_ROOT; ?>/landing/img/choosing-reason.png" alt="">
                </div>
            </div>
            <div class="col-xl-4 col-lg-5 col-sm-10 col-md-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-4">
                            <div class="single-reason">
                                <div class="icon-box">
                                    <div class="part-icon">
                                        <img src="<?=STATIC_ROOT; ?>/landing/img/svg/shield.svg" alt="">
                                    </div>
                                </div>
                                <div class="part-text">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-4">
                            <div class="single-reason">
                                <div class="icon-box">
                                    <div class="part-icon">
                                        <img src="<?=STATIC_ROOT; ?>/landing/img/svg/customer-service.svg" alt="">
                                    </div>
                                </div>
                                <div class="part-text">
