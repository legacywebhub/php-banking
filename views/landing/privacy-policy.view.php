...
<div class="term">
    <div class="container">
        ...
        <p class="date">Last Revised: December 16, 2013</p>
        ...
        <ul>
            <li>generator.lorem-ipsum.info</li>
            <li>126 Electricov St.</li>
            <li>Kiev, Kiev 04176</li>
            <li>Ukraine</li>
            <li>contact@lorem-ipsum.info</li>
        </ul>
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Mollitia soluta commodi molestiae totam similique, quaerat id magnam sed. Excepturi doloribus laudantium exercitationem nisi unde ad incidunt error debitis magni et!</p>
